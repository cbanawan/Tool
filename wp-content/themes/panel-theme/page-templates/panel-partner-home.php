<?php
/**
 * Template Name: Panel Partner Home Page
 */
                                                ...
                                                <div class="fullwidthbanner-container" >
													...
													<ul>
                                                            ...
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/img/slider/slider1p.jpg" alt="">
                                                                ...
                                                                <div class="caption lfl ltl start"
                                                                     ...
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/lsp_img1.png" alt="Image 4">
																</div>    
                                                            </li>
                                        
                                                            <!-- THE SECOND SLIDE -->
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/img/slider/slider2p.jpg" alt="">
                                                                <div class="caption lfl ltl start"
                                                                     data-x="492"
                                                                     data-y="68"
                                                                     data-endeasing="easeInOutBack" 
                                                                     ...
                                                                     data-easing="easeInOutBack" 
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/lsp_img2.png" alt="Image 1">
																</div>              
                                                            </li>
                                                            ...
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                ...
                                                                <div class="caption lfl ltl start"
                                                                     ...
                                                                     data-easing="easeInOutBack" 
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/lsp_img3.png" alt="Image 1">
																</div>              
                                                            </li>
