<?php
/**
 * Template Name: Panel Researcher Home Page
 */
                                            ...
                                            <div class="rs-fullscreen">
                                                <div class="fullwidthbanner-container" >
													...
													<ul>
                                                                ...
                                                                <img src="<?php echo get_template_directory_uri(); ?>/img/slider/slider1r.jpg" alt="">
                                                                ...
                                                                <div class="caption lfl ltl start"
                                                                     ...
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/lsr_img1.png" alt="Image 4">
																</div>    
                                                            </li>
                                        
                                                            <!-- THE SECOND SLIDE -->
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                <img src="<?php echo get_template_directory_uri(); ?>/img/slider/slider2r.jpg" alt="">
                                                                <div class="caption lfl ltl start"
                                                                     data-x="105"
                                                                     data-y="40"
                                                                     data-endeasing="easeInOutBack" 
                                                                     ...
                                                                     data-easing="easeInOutBack" 
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/lsr_img2.png" alt="">
																</div>              
                                                            </li>
                                                            ...
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                ...
                                                                <div class="caption lfl ltl start"
                                                                     ...
                                                                     data-easing="easeInOutBack" 
                                                                     data-start="500" 
                                                                     data-speed="1000"><img src="<?php echo get_template_directory_uri(); ?>/img/slider/ls1_img1.png" alt="">
																</div>              
                                                            </li>
                                                            ...
                                                            <li data-masterspeed="400" data-slotamount="7" data-transition="fade">
                                                                ...
                                                                <div class="caption lfr start"
                                                                    ...
                                                                    data-easing="easeInOutBack" 
                                                                    data-start="500" 
                                                                    data-speed="1000"> <iframe width="560" height="315" src="//www.youtube.com/embed/j83VRUVc5Tw" frameborder="0" allowfullscreen></iframe>
																</div>
