...
$('a[id^="btn-close-partner_"]').live('click', function() {
	...
	if (close_return == true) {
		...
		var partner_rank = $('#partner-rank_'+partner_id).val();
		var partner_cost_rank = $('#partner-cost-rank_'+partner_id).val();
            ...
            $.ajax({
				...
				success: function(response) {
						if (response == 'success') {
							...
							$('#edit-project-nav .tablink .tab_search_partner').trigger("click");
