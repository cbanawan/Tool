            ...
            <div class="row">
                ...
                <div class="col-md-12">            
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control" name="email_template_content" id="email_template_content" placeholder="Email Template Content"><?php echo (isset($email_templates)) ? $email_templates['email_template_content'] : ""; ?></textarea>                                            
                    </div>					                 
                </div>                      
            </div>
