...
<div class="show_form">
		...
		<div class="form-body">
			<div class="row">
				...
				<div class="col-md-3" style="margin-top:30px;"> 
					<input class="btn green" value="Edit Project" type="submit" id="btn_project" />					
					<a href="<?php echo base_url("projects");?>" class="btn default" >Cancel</a>
					
				</div>
			</div>
			<div class="row">
				<div class=" col-md-3" style="margin-bottom:20px;"><a href="javascript:void(0)" class="btn blue" id="add_project_details">Add Segments</a>&nbsp;&nbsp;<a href="javascript:void(0)" class="btn blue" id="add_project_files">Add File</a></div>
				<div class="col-md-9"><?php $f=0; 
		...
		<div id="add_files_detail" style="display:none;">
			<form class="horizontal-form" role="form" id="frmProject" action="<?php echo base_url(); ?>projects/insert_project_files" method="post" enctype="multipart/form-data">
			<input type="hidden" id="project_id" name="project_id" value="<?php echo (isset($projects)) ? $projects['project_id'] : ""; ?>" /> 
			...
			<div class="row">
				<div class="col-md-2">
					...
					<input type="file" class="form-control" id="project_file" name="project_file" placeholder="Project File" value=""  />                    
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
					<label for="project_file_name" class="control-label">File Name</label>
					<input type="text" class="form-control" id="project_file_name" name="project_file_name" placeholder="Project File" value=""  />                    
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
					<label for="project_file_description" class="control-label">File Description</label>
					<textarea class="form-control" id="project_file_description" name="project_file_description" placeholder="Project File Description" style="height:34px;"></textarea>                    
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
					<label for="project_file_description" class="control-label">Project Segment</label>
					<select class="form-control" id="project_file_segment" name="project_file_segment" placeholder="Project File Description"><option value="0">All</option> <?php foreach($projects_country_details as $pc_val) { 
						echo '<option value="'.$pc_val['project_country_id'].'">'.$pc_val['segment_name'].'</option>';
}?>	</select>				
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label><input type="checkbox" name="opt_for_bid" value="Yes"/> Includes in Bids</label>
					</div>
				</div>
			</div>
		...
		<div id="edit_prj_detail" style="display:none;">
			<form class="horizontal-form" role="form" id="frmProject" action="<?php echo base_url(); ?>projects/insert_project_country" method="post">
			<input type="hidden" id="project_id" name="project_id" value="<?php echo (isset($projects)) ? $projects['project_id'] : ""; ?>" /> 
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<input type="text" class="form-control segment_name" name="segment_name" placeholder="Segment" value=""  />                    
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
				...
				<div class="col-md-2"> 
					<div class="form-group">
						<label for="project_target" class="control-label">Project Target</label>            
						...
						<table class="table table-striped table-bordered table-advance table-hover">
							...
							foreach($projects_country_details as $pc_val) { 
								...
								<tr class="project_country_detail <?php echo $tr_class;?>" id="prj_country_<?php echo $pc_val['project_country_id'];?>">
									...
									echo '<div class="pr_info proj_info_'.$pc_val['project_country_id'].'">'.$cname->country_name.'</div>';?><div class="pr_input proj_input_<?php echo $pc_val['project_country_id'];?>" style="display:none;"><select class="form-control" name="edit_project_country" id="edit_project_country_<?php echo $pc_val['project_country_id'];?>" style="width:150px;"><?php
						if (!empty($country)) {
							foreach ($country as $value) {
