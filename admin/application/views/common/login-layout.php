...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="<?php echo base_url().JS; ?>uniform/css/uniform.default.css" rel="stylesheet" type="text/css"/>
...
<!--        <link href="<?php //echo base_url(); ?>/assets/css/custom.css" rel="stylesheet" type="text/css"/>-->
    ...
    <body class="login">
        ...
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url() . IMAGES; ?>logo-big.png" alt=""/></a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
        ...
        <!-- END CONTENT -->
        <div class="copyright">2015 &copy; PangeaPanel.</div>
        <!-- END LOGIN -->
