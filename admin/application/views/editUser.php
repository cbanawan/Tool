<div class="col-md-8 ">
	...
	<div class="portlet box green ">
		...
		<div class="portlet-body form">
			<form class="form-horizontal" role="form" action="<?php echo base_url('/manageUser/update_user')?>" id="frm-user" method="post">
			<input type="text" name="user_id" id="user_id" value="<?php echo $user_rs['user_id']; ?>" >
				<div class="form-body">
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="user_name" id="user_name" placeholder="Full Name" value="<?php echo $user_rs->user_name; ?>">
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input type="text" class="form-control " placeholder="User Name" name="user_login" id="user_login" value="<?php echo $user_rs->user_login; ?>">
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input type="email" class="form-control" placeholder="Email Address" name="user_email" id="user_email" value="<?php echo $user_rs->user_email; ?>">
							</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input class="form-control " type="password" placeholder="Password" name="user_password" id="user_password" autocomplete="off" value="<?php echo $user_rs->user_password; ?>">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								...
								<input class="form-control" type="password" placeholder="Confirm Password" name="user_confirm_password" id="user_confirm_password" autocomplete="off" value="<?php echo $user_rs->user_name; ?>" >
	...
	function validate_user_login(){
		if(user_login.val() == ""){
			...
			jQuery.ajax({
				...
				data: "user_login=" + user_login.val() +"&user_id =" + user_id.val(),
				async: false,
